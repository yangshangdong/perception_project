...
class RandomMoveWithCamera:
    def __init__(self):
        ...
        self.path = '/home/xtark/Desktop/perception_project/MR_data_collection/datas_'+ timestamp 
    ...
    def move_backward(self):
        r = rospy.Rate(self.rate)
        # Set the distance to travel
        self.test_distance = rospy.get_param('~test_distance', 0.1) # meters
