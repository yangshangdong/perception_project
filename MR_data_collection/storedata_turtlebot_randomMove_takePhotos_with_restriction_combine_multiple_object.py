...
class RandomMoveWithCamera:
    ...
    def random_move(self):
        ...
        boxes = [self.box1_pose, self.box2_pose, ...]
        for box in boxes:
            if future_x >= box.x and future_x <= (box.x + box.width) and future_y >= box.y and future_y <= (box.y + box.height):
                rospy.loginfo("Future position collides with a box, do a void action")
                return None
